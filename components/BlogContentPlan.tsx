    ...
    <>
      <div className="bg-slate-900/50 border border-white/5 rounded-[32px] p-8 hover:border-blue-500/30 transition-all duration-500 flex flex-col group relative backdrop-blur-sm">
        ...
        <div className="space-y-6 mb-8">
          <div>
            <h5 className="text-[9px] font-black text-slate-600 uppercase mb-2 tracking-widest-label">Strategic Focus</h5>
            <p className="text-sm text-slate-400 leading-relaxed font-medium line-clamp-3 h-15">
              {post.outline}
            </p>
          </div>
